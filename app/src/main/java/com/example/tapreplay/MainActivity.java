...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("抖音筛选分享 · Android V0.6");
        ...
        note.setText(
                "说明：\n" +
                "• 悬浮条左边是开始/停止，右边显示当前进度和判断结果。\n" +
                "• 只有判断为“符合”的视频才会尝试分享。\n" +
                "• V0.6 把分享过程拆成①找分享、②认分享栏、③找联系人、④点联系人、⑤找发送、⑥发送，每一步都会直接显示卡在哪里。\n" +
                "• 找联系人会先原地连续确认，不会一没认出来就立刻把联系人横条滑走。\n" +
                "• 目标昵称会在整个“分享给”联系人安全区域精确查找，不再只依赖某个列表边界。\n" +
                "• 只认右侧操作栏的真实分享按钮；“分享此刻想法”“分享给你”“私信”等不会当成分享。\n" +
                "• 如果发送按钮已经亮了，不会再重复点联系人，避免把已经选中的对象取消。\n" +
                "• 分享等待时间已明显缩短；失败时会保留当前页面，方便直接看是哪一步的问题。\n" +
                "• 如果键盘意外弹出，会先自动收起。\n" +
