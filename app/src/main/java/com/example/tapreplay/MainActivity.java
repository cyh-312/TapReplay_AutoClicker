...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("抖音筛选分享 · Android V0.5");
        ...
        note.setText(
                ...
                "• 只有判断为“符合”的视频才会尝试分享。\n" +
                "• V0.5 的分享流程按电脑稳定版思路重写：每一步都重新读取当前抖音页面。\n" +
                "• 只认右侧操作栏的真实分享按钮；“分享此刻想法”“分享给你”“私信”等不会当成分享。\n" +
                "• 点分享后必须确认“分享给”面板已经出现，才会继续找联系人。\n" +
                "• 分享对象只在联系人横条中精确匹配；遇到同名或页面不确定时不会乱点。\n" +
                "• 发送按钮先看界面节点，找不到再用内存画面识别底部大红色发送按钮。\n" +
                "• 如果键盘意外弹出，会先自动收起并重新确认当前页面。\n" +
