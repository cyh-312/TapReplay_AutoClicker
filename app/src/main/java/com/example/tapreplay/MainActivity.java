...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desc.setText(
                ...
                "截图和视频画面只在内存中处理，不写入相册或电脑；会保留约 5 MiB 的运行诊断文本日志。\n\n" +
                "这一版只用于内部长时间稳定性测试，重点观察内存、温控、模型推理和屏幕采集恢复。\n" +
        ...
        note.setText(
                "说明：\n" +
                "• 悬浮条左边是开始/停止，右边固定两行显示当前进度和失败位置。\n" +
                "• 只有判断为“符合”的视频才会尝试分享。\n" +
                "• 分享过程按①找分享、②确认分享栏、③找好友、④点好友、⑤找发送、⑥发送显示。\n" +
                "• 只认右侧操作栏的真实分享按钮；“分享此刻想法”“分享给你”“私信”等不会当成分享。\n" +
                "• 必须确认页面出现精确的“分享给”后才会继续。\n" +
                "• 只查当前可见联系人，不自动横滑联系人栏；单次分享失败会尝试恢复视频页并继续下一条。\n" +
